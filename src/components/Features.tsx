      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Powerful AI Image Generation, <br className="hidden sm:block" />Simple User Experience
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Transform your text prompts into stunning digital artwork with our advanced AI technology.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Transform your text descriptions into high-quality digital artwork with our advanced AI models."
            index={0}
          />
          <FeatureCard
            ...
            description="Simple and intuitive design makes AI image generation accessible to everyone, no technical skills required."
            index={1}
          />
          <FeatureCard
            ...
            description="Generate stunning, high-resolution images suitable for professional use in various applications."
            index={2}
          />
          <FeatureCard
            ...
            description="Perfect for content creators, social media posts, product mockups, and creative projects."
            index={3}
          />
          <FeatureCard
            ...
            description="Your prompts and generated images are kept secure and private with enterprise-grade security."
            index={4}
          />
          <FeatureCard
            ...
            description="Get your AI-generated images within seconds, perfect for quick content creation and iteration."
            index={5}
          />
        </div>
      </div>
